...
- When a feature or behavior already exists in `origin/dev`, use that upstream implementation directly — do not write new or parallel code for it in the fork. If upstream already does it, reuse it; only fork-specific adaptation is allowed.
