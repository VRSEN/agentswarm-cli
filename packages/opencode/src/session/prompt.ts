              ...
              const result = yield* handle.process({
                ...
                createStream: (abort) =>
                  SessionAgencySwarm.stream({
                    ...
                    loadSessionMessages: () => bridge.promise(sessions.messages({ sessionID })),
                    updateSessionMessage: <T extends MessageV2.Info>(message: T) =>
                      bridge.promise(sessions.updateMessage(message)),
                  }),
              })
