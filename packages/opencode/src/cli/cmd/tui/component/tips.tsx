...
const TIPS = [
  ...
  "Agency Code auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Agency Code auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Agency Code uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Agency Code from reading sensitive files",
  "Use {highlight}agency run{/highlight} for non-interactive scripting",
  "Use {highlight}agency --continue{/highlight} to resume the last session",
  "Use {highlight}agency run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}agency serve{/highlight} for headless API access to Agency Code",
  "Use {highlight}agency run --attach{/highlight} to connect to a running server",
  "Run {highlight}agency upgrade{/highlight} to update to the latest version",
  "Run {highlight}agency auth list{/highlight} to see all configured providers",
  "Run {highlight}agency agent create{/highlight} for guided agent creation",
  "Use {highlight}/agency{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}agency github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/agency fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}agency debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/agency-ai-solutions/agency-code{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} to configure provider credentials",
