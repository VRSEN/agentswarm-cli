...
const TIPS = [
  ...
  "Run {highlight}/compact{/highlight} to summarize long agency-swarm sessions near context limits",
  ...
  "agent-swarm-cli auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "agent-swarm-cli uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent agent-swarm-cli from reading sensitive files",
  "Use {highlight}agentswarm run{/highlight} for non-interactive scripting",
  "Use {highlight}agentswarm --continue{/highlight} to resume the last session",
  "Use {highlight}agentswarm run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Use {highlight}agentswarm run --attach{/highlight} to connect to a running server",
  "Run {highlight}agentswarm upgrade{/highlight} to update to the latest version",
  "Run {highlight}agentswarm auth list{/highlight} to see the stored agency-swarm token",
  "Run {highlight}agentswarm agent create{/highlight} for guided agent creation",
  ...
  "Run {highlight}agentswarm debug config{/highlight} to troubleshoot configuration",
