...
export const exerciseConfigDirectory = path.join(exerciseGlobalRoot, "config", "agentswarm")
export const exerciseDataDirectory = path.join(exerciseGlobalRoot, "data", "agentswarm")
