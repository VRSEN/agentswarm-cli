...
- **Downstream product profile inputs**
  ...
  - Behavior: downstream profiles can set `AGENTSWARM_PRODUCT_LOCK_MODEL_SELECTION` to keep users on the configured provider/model path after auth and hide `/models`.
