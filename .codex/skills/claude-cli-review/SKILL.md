...
Use Claude CLI only when active higher-priority operating policy allows it. Treat it as supporting evidence; managers must verify its output before final decisions.
