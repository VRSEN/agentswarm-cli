...
7. Follow the policy, repo-skill, and workflow-rule model floor in Tool And Model Policy: isolated worker or worktree, GPT-5.5 with `high` reasoning when available, with any substitution stated before relying on it.
